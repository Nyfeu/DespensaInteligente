...
public class LanguageManager {
    ...
    private void loadResourceBundle() {
        ...
        resourceBundle = ResourceBundle.getBundle("resources.properties.DespensaInteligente", currentLocale);
    ...
    private void updateLanguageIcon() {
        ...
        String iconPath = "resources/images/" + currentLocale.getLanguage() + "_" + currentLocale.getCountry() + ".png";
